                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtNombreD, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
                            .addComponent(txtDepartamento)
                            .addComponent(txtZona)
                            .addComponent(txtNumZona)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(178, 178, 178)
     ...
     private void guardarDatos() throws SQLException{
        ...
        if(txtNombreD.getText().equals("")){
           ...
           con = databaseControl.DatabaseHandler.getConnection();
            ...
            ps = con.prepareStatement("insert into departamentos (nombreDepartamento, idDepartamento, encargadoZona, numZona) values (?, ?, ?, ?)");
            ps.setString(1, txtNombreD.getText());
            ps.setString(2, txtDepartamento.getText());
            ps.setString(3, txtZona.getText());
            ps.setString(4, txtNumZona.getText());
            ...
            if (res > 0) {
                JOptionPane.showMessageDialog(null, "El Departamento se registro con éxito!");
                this.limpiar();
            }else{
